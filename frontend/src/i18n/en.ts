...
const englishMessages: Partial<TranslationMessages> = {
  resources: {
    ...
    assets: {
      ...
      tabs: {
        ...
        dataPrivacyTab: {
          description:
            "Information about data privacy handling for personal data.",
          shortDescription:
      ...
      create: {
        ...
        provenance: {
          description:
            "Document where this dataset came from and how it was created.",
          fields: {
            wasDerivedFrom: "Was Derived From",
        ...
        dataPrivacy: {
          description:
            "Define how personal data is collected, processed, and protected in this asset.",
          fields: {
            personalDataHandling: "Personal Data Handling",
        ...
        dataQuality: {
          description:
            "Add quality measurements and assessments for this asset.",
          fields: {
            qualityMeasurements: "Quality Measurements",
            measurement: "Measurement",
  ...
  catalog: {
    ...
    forms: {
      urlHelper:
        "Enter the EDC catalog endpoint URL (e.g., https://example.com/api/dsp)",
  ...
  transferprocesses: {
    ...
    messages: {
      cannotTerminateCompleted:
        "Completed transfer processes cannot be terminated.",
    ...
    create: {
      fields: {
        ...
        transferTypeHelper: "The type of transfer",
        dataDestinationTypeHelper: "The type of data destination",
        ...
        objectNameHelper: "The name of the object in the Amazon S3 bucket",
